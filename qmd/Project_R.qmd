...
# Utiliser type = "norm" au lieu du type par défaut "t"
...
print(p10)
```
 Interprétation du Clustering : 3 Profils Distincts
 Résultats du Clustering K-means (k=3)
Le clustering identifie trois segments distincts d'utilisateurs avec des résultats contre-intuitifs :

🟡 Cluster 1 (42.2%) : Usage Modéré - Anxiété Modérée
Profil : Utilisateurs "moyens"

Proportion : Plus grand groupe (42%)
Usage quotidien : ~84 minutes/jour
Anxiété : 21.1% - taux le plus élevé des trois clusters (!!)
Caractéristiques :

Engagement modéré
Ni très actifs, ni très passifs
Paradoxalement le groupe le MOINS bien protégé



 Interprétation : Groupe intermédiaire sans stratégie claire d'usage

🟢Cluster 2 (31.2%) : Usage Prudent - Profil Optimal
Profil : Les "utilisateurs sains" ✅

Proportion : Second groupe (31%)
Usage quotidien : ~67 minutes/jour (le plus faible)
Anxiété : 16.3% - taux le PLUS BAS ✅
Caractéristiques :

Usage limité et contrôlé
Engagement raisonnable
Le profil à promouvoir



💡 Interprétation : Usage modéré = protection optimale contre l'anxiété

🔴 Cluster 3 (26.6%) : Usage Intensif - Paradoxe Majeur
Profil : Les "power users" résilients (!?)

Proportion : Plus petit groupe (27%)
Usage quotidien : ~150 minutes/jour (le plus élevé - 2.5h)
Anxiété : 11.3% - taux TRÈS BAS (!!)
Caractéristiques :
